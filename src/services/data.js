  ...
  results: [
    {
      ...
      films: [
        'https://swapi-trybe.herokuapp.com/api/films/1/H',
        'https://swapi-trybe.herokuapp.com/api/films/3/H',
        'https://swapi-trybe.herokuapp.com/api/films/4/H',
        'https://swapi-trybe.herokuapp.com/api/films/5/H',
        'https://swapi-trybe.herokuapp.com/api/films/6/H',
      ],
    ...
    },
    {
      ...
      residents: [],
      films: [
        'https://swapi-trybe.herokuapp.com/api/films/2/H',
      ],
    ...
    },
    {
      ...
      residents: [],
      films: [
        'https://swapi-trybe.herokuapp.com/api/films/2/A',
        'https://swapi-trybe.herokuapp.com/api/films/3/A',
        'https://swapi-trybe.herokuapp.com/api/films/6/A',
      ],
    ...
    },
    {
      ...
      films: [
        'https://swapi-trybe.herokuapp.com/api/films/3/X',
      ],
    ...
    },
    {
      ...
      films: [
        ...
        'https://swapi-trybe.herokuapp.com/api/films/5/X',
